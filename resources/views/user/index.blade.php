...
@section('title', 'Data User - E-Ticketing System')
...
@section('content')
    <div class="flex min-h-screen bg-[#001D39]">
        ...
        <div class="flex-1 p-6 overflow-y-auto" style="height: 100vh;">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white mb-2">Data User</h1>
            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div class="relative">
                        <input type="text" placeholder="Cari nama, jabatan, username atau role..."
        ...
        <div id="userModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-[#001D39] border border-white/10 rounded-2xl w-full max-w-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl font-semibold text-white" id="modalTitle">Tambah User</h3>
                ...
                <form id="userForm">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="nama_error" class="text-red-400 text-xs mt-1 hidden"></div>
                    </div>

                    <div class="mb-4">
                        <label for="jabatan" class="block text-sm font-medium text-gray-300 mb-2">Jabatan</label>
                        <input type="text" id="jabatan" name="jabatan"
                            class="w-full bg-white/5 border border-white/10 text-white rounded-lg px-4 py-2.5 focus:border-blue-400 focus:outline-none transition-colors"
                            placeholder="Masukkan jabatan">
                        <div id="jabatan_error" class="text-red-400 text-xs mt-1 hidden"></div>
                    </div>
                    ...
                    <div class="mb-4">
                        <label for="password" class="block text-sm font-medium text-gray-300 mb-2">
                            Password <span id="passwordHint" class="text-gray-400 text-xs">(min. 6 karakter)</span>
                        </label>
                        <input type="password" id="password" name="password"
                            class="w-full bg-white/5 border border-white/10 text-white rounded-lg px-4 py-2.5 focus:border-blue-400 focus:outline-none transition-colors"
                            placeholder="Masukkan password">
                        <div id="password_error" class="text-red-400 text-xs mt-1 hidden"></div>
                        <p id="passwordEditHint" class="text-gray-400 text-xs mt-1 hidden">Kosongkan jika tidak ingin
                            mengubah
                            password</p>
                    </div>
        ...
        <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-[#001D39] border border-white/10 rounded-2xl w-full max-w-md p-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-400 mb-6">Apakah Anda yakin ingin menghapus user <span id="deleteUserName"
...
@push('scripts')
    <script>
        ...
        function openCreateModal() {
            ...
            // Show password field as required for create
        ...
        // Open edit modal
        function openEditModal(id, nama, jabatan, username, roleId) {
