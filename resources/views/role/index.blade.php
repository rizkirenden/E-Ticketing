...
@section('title', 'Role - E-Ticketing System')
...
@section('content')
    <div class="flex min-h-screen bg-[#001D39]">
        ...
        <div class="flex-1 p-6 overflow-y-auto" style="height: 100vh;">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white mb-2">Role</h1>
                <p class="text-gray-400">Kelola role dalam sistem</p>
            </div>
                ...
                <div class="flex items-center gap-3">
                    <div class="relative">
                        <input type="text" placeholder="Cari role..."
                            class="bg-white/5 border border-white/10 text-gray-300 text-sm rounded-lg pl-10 pr-4 py-2.5 w-64 focus:border-blue-400 focus:outline-none transition-colors"
        ...
        <div id="roleModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-[#001D39] border border-white/10 rounded-2xl w-full max-w-md p-6">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-xl font-semibold text-white" id="modalTitle">Tambah Role</h3>
                ...
                <form id="roleForm">
                    ...
                    <div class="mb-4">
                        <label for="nama_role" class="block text-sm font-medium text-gray-300 mb-2">Nama Role</label>
                        ...
                        <div id="nama_role_error" class="text-red-400 text-xs mt-1 hidden"></div>
                    </div>
        ...
        <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
            <div class="bg-[#001D39] border border-white/10 rounded-2xl w-full max-w-md p-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-400 mb-6">Apakah Anda yakin ingin menghapus role <span id="deleteRoleName"
...
@push('scripts')
    <script>
        ...
        function openCreateModal() {
            ...
            document.getElementById('nama_role_error').classList.add('hidden');
        ...
        // Open edit modal
        function openEditModal(id, namaRole) {
            ...
            document.getElementById('nama_role').value = namaRole;
            document.getElementById('nama_role_error').classList.add('hidden');
            document.getElementById('nama_role_error').textContent = '';
        ...
        // Open delete modal
        function openDeleteModal(id, namaRole) {
            if (!permissions.can_delete) {
                alert('Anda tidak memiliki izin untuk menghapus data');
                return;
            }
            document.getElementById('deleteRoleId').value = id;
            document.getElementById('deleteRoleName').textContent = namaRole;
        ...
        document.getElementById('roleForm').addEventListener('submit', function(e) {
            ...
            const url = roleId ? `/role/${roleId}` : '/role';
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.status === 'error') {
                        ...
                        if (data.errors && data.errors.nama_role) {
                            document.getElementById('nama_role_error').textContent = data.errors.nama_role[0];
                            document.getElementById('nama_role_error').classList.remove('hidden');
                        } else {
        ...
        if (searchInput) {
            searchInput.addEventListener('keyup', function() {
                ...
                searchTimeout = setTimeout(fetchRoles, 500); // Debounce 500ms
            });
        }
